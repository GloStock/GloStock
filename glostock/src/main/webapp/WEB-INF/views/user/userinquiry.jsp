...
<div class="row">
  ...
  <div class="col-lg-12">
    <h3 class="pb-2 fst-italic border-bottom">User Feedback</h3>
  </div>
  <!-- /.col-lg-12 -->
...
<div class="row">
  <div class="col-lg-12">
    <div class="card">
      <div class="card-header text-light bg-dark"><strong>문의(건의)사항 등록하기</strong></div>
      <div class="card-body">

        <form role="form" id="userinquiry" name="userinquiry" action="userInquiry" method="post" id="regform">
          ...
          <div class="form-group">
            <label>이메일</label>
            <input class="form-control" name="email" id="email" placeholder="${mypage.email}" value="${mypage.email}"  readonly>
          </div>
          <div class="text_height_10"></div>
          ...
          <button class="btn btn-outline-dark btn-sm" onclick="register()">등록</button>
