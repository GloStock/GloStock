...
<%--          <span class="navbar-toggler-icon"></span>--%>
<%--        </button>--%>
>>>>>>> 1ed3dd683f1baa0bea0b16a086c81a5ad138ffac
...
<%--                <li><a class="dropdown-item" href="#">My Count</a></li>--%>
...
<%--              <ul class="dropdown-menu" aria-labelledby="dropdown10">--%>
<%--                <li><a class="dropdown-item" href="#">Total Board</a></li>--%>
<%--                <li><a class="dropdown-item" href="#">Hot Board</a></li>--%>
